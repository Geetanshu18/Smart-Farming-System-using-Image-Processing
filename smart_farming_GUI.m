...
function varargout = smart_farming_GUI(varargin)

gui_Singleton = 1;
gui_State = struct('gui_Name',       mfilename, ...
                   'gui_Singleton',  gui_Singleton, ...
                   'gui_OpeningFcn', @smart_farming_GUI_OpeningFcn, ...
                   'gui_OutputFcn',  @smart_farming_GUI_OutputFcn, ...
                   'gui_LayoutFcn',  [] , ...
                   'gui_Callback',   []);
...
function smart_farming_GUI_OpeningFcn(hObject, eventdata, handles, varargin)
...
function varargout = smart_farming_GUI_OutputFcn(hObject, eventdata, handles) 
